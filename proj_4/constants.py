...
# Fields Inclusion/Exclusion - To make SSN unique
...
compress_fileds = (
    personal_fields_compress, employement_fields_compress, vehicle_fields_compress, update_status_fields_compress
    )
